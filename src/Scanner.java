...
public class Scanner {
    ...
    private boolean match(char expected) { // Checks if the current character matches the expected character.
    ...
    private char peek() { // Returns the current character without consuming it.
        if(isAtEnd()) return '\0';
        return source.charAt(current);
    }
    ...
    private void string() {
        ...
        // Unterminated string.
        if(isAtEnd()) {
            Brahma.error(line, "Unterminated string.");
            return;
        }
